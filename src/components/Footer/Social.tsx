  ...
  return (
    <div className='w-full flex flex-col gap-16 justify-between '>
      <div className='flex flex-col items-start lg:items-end'>
        ...
        <p className='text-md lg:text-lg mb-4 text-semibold'>Get in touch with us on social media.</p>
      ...
      <div className='flex flex-col items-start lg:items-end'>
        ...
        <p className='text-md lg:text-lg mt-4'>Copyright © 2023 Pixel Tech. All rights reserved.</p>
      </div>
    </div>
  );
};
